...
export default function Meja() {
  ...
  return (
    ...
    <div className="container mx-auto"> {/* tambahkan kelas container */}
      <h1 className="text-pink-500 my-4 text-center">Daftar Meja</h1>
    </div>
    </Typography> 
          ...
          <tbody className="bg-pink-200 divide-y divide-gray-700 text-base">
            {mejas.map((item, index) => (
              <tr key={item.id} className="hover:bg-amber-100">
                ...
                <td align="center" className="py-3 px-4">{item.nomor_meja}</td>
                <td align="center" className="py-3 px-4">{item.status}</td>
