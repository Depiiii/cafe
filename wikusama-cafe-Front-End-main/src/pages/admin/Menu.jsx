...
export default function Menu() {
  ...
  return (
    ...
    <div className="container mx-auto"> {/* tambahkan kelas container */}
      <h1 className="text-pink-500 my-4 text-center">Daftar Menu</h1>
    </div>
    </Typography>
        ...
        <table className="w-full mt-4 border-collapse">
          ...
          <tbody className="bg-pink-200 divide-y divide-gray-700 text-base">
            {menus.map((item, index) => (
              <tr key={item.id} className="hover:bg-amber-100">
                <td align="center" className="py-3 px-4">{index + 1}</td>
                <td align="center" className="py-3 px-4">{item.nama_menu}</td>
                <td align="center" className="py-3 px-4">{item.jenis}</td>
                <td align="center" className="py-3 px-4">{item.harga}</td>
                <td align="center" className="py-3 px-4">{item.deskripsi}</td>
