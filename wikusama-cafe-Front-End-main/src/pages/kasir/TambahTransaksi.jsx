    ...
    <div className="py-6 overflow-auto">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4 mx-14 sm:p-5">
        ...
        <div className="col-span-2 mt-10">
          <table className="w-full text-md bg-slate-200 shadow-md rounded mb-5 ">
            <thead>
                ...
                <tr key={menu.id} className="hover:bg-gray-300">
                  ...
                  <td className="text-center p-3 px-5">
                    <input
                      type="number"
                      value={
                        detailTransaksi.find((item) => item.id_menu === menu.id)?.qty || 0
                      }
                      min="0"
                      max="99"
                      onChange={(event) =>
        ...
        <button
          type="submit"
          className="btn bg-green-700 hover:bg-green-500 text-white font-bold py-1 px-2 rounded-md no-underline inline-block cursor-pointer"
        >
          Tambah Transaksi
        </button>
      </form>
